...
# Eliminar imágenes personalizadas (opcional)
# docker image rm -f docker-nodered docker-pandas_script 2>/dev/null || true
...
docker volume ls
echo
echo "✅ Entorno limpio. Puedes ejecutar './start_all.sh' desde scripts/"
echo "========================================="
